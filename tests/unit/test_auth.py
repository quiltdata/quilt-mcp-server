...
class TestExtractCatalogNameFromUrl:
    ...
    def test_extract_catalog_name_with_parsing_exception(self):
        ...
        with patch('quilt_mcp.tools.catalog.urlparse', side_effect=Exception("Parse error")):
    ...
    def test_extract_catalog_name_with_netloc_fallback(self):
        ...
        with patch('quilt_mcp.tools.catalog.urlparse') as mock_urlparse:
            mock_parsed = Mock()
...
class TestCatalogInfo:
    ...
    def test_catalog_info_success_authenticated(self):
        ...
        with patch('quilt_mcp.tools.catalog._get_catalog_info', return_value=mock_info):
            result = catalog_info()
    ...
    def test_catalog_info_with_exception(self):
        ...
        with patch('quilt_mcp.tools.catalog._get_catalog_info', side_effect=Exception("Info error")):
            result = catalog_info()
...
class TestAuthStatus:
    ...
    def test_auth_status_main_exception(self):
        ...
        with patch('quilt_mcp.tools.catalog.QuiltService', side_effect=Exception("Service error")):
            result = catalog_status()
...
class TestSwitchCatalog:
    ...
    def test_switch_catalog_with_full_url(self):
        ...
        with patch('quilt_mcp.tools.catalog.QuiltService') as mock_service_class:
            ...
            mock_service.set_config.assert_called_with("https://custom.quiltdata.com")
            assert result["status"] == "success"
            assert result["to_catalog"] == "custom.quiltdata.com"
    ...
    def test_switch_catalog_with_unknown_catalog_name(self):
        ...
        with patch('quilt_mcp.tools.catalog.QuiltService') as mock_service_class:
            ...
            mock_service.set_config.assert_called_with("https://custom")
            assert result["status"] == "success"
            assert result["to_catalog"] == "custom"

    def test_switch_catalog_with_exception(self):
        """Test exception handling in switch_catalog."""
        with patch('quilt_mcp.tools.catalog.QuiltService', side_effect=Exception("Switch error")):
            result = catalog_set("demo")
