...
class TestBackendError:
    ...
    def test_backend_error_creation_with_backend_type(self):
        ...
        context = {"backend_type": "quilt3", "operation": "search_packages", "error_details": "Network timeout"}
...
class TestExceptionMessages:
    ...
    def test_exception_message_clarity(self):
        ...
        error = AuthenticationError("JWT token has expired and cannot be used for authentication", context=context)
...
class TestExceptionUsagePatterns:
    ...
    def test_chaining_exceptions(self):
        ...
        try:
            ...
            context = {"backend_type": "quilt3", "original_exception": str(original), "operation": "package_search"}

            backend_error = BackendError("Package search failed due to invalid parameters", context=context)
    ...
    def test_error_context_serialization(self):
        ...
        context = {
            "validation_errors": [{"field": "name", "error": "required"}, {"field": "tags", "error": "must be list"}],
