...
class TestCatalogConfigTypeHints:
    ...
    def test_catalog_config_has_correct_type_annotations(self):
        ...
        assert type_hints['api_gateway_endpoint'] == str
        assert type_hints['analytics_bucket'] == str
        assert type_hints['stack_prefix'] == str
        assert type_hints['tabulator_data_catalog'] == str
    ...
    def test_catalog_config_dataclass_properties(self):
        ...
        expected_fields = {
            'region', 'api_gateway_endpoint', 'analytics_bucket', 
            'stack_prefix', 'tabulator_data_catalog'
        }
        assert field_names == expected_fields
        
        # Check field types
        field_types = {f.name: f.type for f in fields}
        assert field_types['region'] == str
        assert field_types['api_gateway_endpoint'] == str
        assert field_types['analytics_bucket'] == str
        assert field_types['stack_prefix'] == str
        assert field_types['tabulator_data_catalog'] == str
