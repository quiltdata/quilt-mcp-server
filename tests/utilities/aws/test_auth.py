...
class TestCredentialRetrieval:
    ...
    def test_given_quilt_catalog_login_when_getting_credentials_with_prefer_quilt_true_then_quilt3_credentials_returned(self):
    ...
    def test_given_aws_profile_when_getting_credentials_with_prefer_quilt_false_then_profile_credentials_returned(self):
    ...
    def test_given_both_credential_types_available_when_getting_credentials_with_default_settings_then_quilt3_credentials_preferred(self):
...
class TestCredentialValidation:
    ...
    def test_given_valid_native_aws_credentials_when_validating_then_validation_succeeds_with_native_aws_identity(self):
    ...
    def test_given_expired_credentials_when_validating_then_validation_fails_with_refresh_guidance(self):
        ...
        with patch('boto3.Session') as mock_session_class:
            ...
            from botocore.exceptions import ClientError
            mock_sts_client.get_caller_identity.side_effect = ClientError(
                {'Error': {'Code': 'TokenRefreshRequired', 'Message': 'Token has expired'}},
                'get_caller_identity'
            )
...
class TestCredentialTypeDetection:
    ...
    def test_given_ambiguous_session_when_getting_credential_type_then_unknown_returned(self):
        """Given ambiguous session, When getting credential type, Then 'unknown' returned."""
