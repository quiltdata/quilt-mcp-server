...
class FileAnalyzer:
    ...
    DATA_EXTENSIONS = {
        'csv', 'tsv', 'xlsx', 'xls', 'json', 'parquet', 'h5', 'hdf5',
        'feather', 'arrow', 'pickle', 'pkl', 'npy', 'npz'
    }
    
    # Genomic file extensions
    GENOMIC_EXTENSIONS = {
        'bam', 'sam', 'vcf', 'bed', 'gtf', 'gff', 'gff3', 'fasta', 'fa',
        'fastq', 'fq', 'bw', 'bigwig', 'bb', 'bigbed', 'maf', 'ped', 'map'
    }
    ...
    TEXT_EXTENSIONS = {
        'txt', 'md', 'rst', 'log', 'out', 'err', 'sh', 'py', 'r', 'sql'
    }
