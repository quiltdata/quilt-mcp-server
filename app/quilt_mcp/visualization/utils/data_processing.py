...
class DataProcessor:
    ...
    def __init__(self):
        ...
        self.supported_formats = {'csv', 'tsv', 'json', 'xlsx', 'xls', 'parquet', 'h5', 'hdf5'}
    ...
    def get_data_summary(self, data: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            return {'type': type(data).__name__, 'note': 'pandas not available for detailed analysis'}
        except Exception as e:
            return {'error': str(e)}
    ...
    def create_sample_dataset(self, size: int = 100) -> Any:
        ...
        try:
            ...
            print("pandas/numpy not available for sample dataset creation", file=sys.stderr)
            return None
        except Exception as e:
