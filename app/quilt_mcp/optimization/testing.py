...
class ScenarioRunner:
    ...
    async def run_scenario(self, scenario: TestScenario) -> TestResult:
        ...
        logger.info(f"Scenario {scenario.name} completed: success={success}, "
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'avg_efficiency_score': statistics.mean([r.efficiency_score for r in successful_results]) if successful_results else 0,
            'avg_execution_time': statistics.mean([r.total_time for r in successful_results]) if successful_results else 0,
            'avg_call_count': statistics.mean([r.total_calls for r in successful_results]) if successful_results else 0,
...
class OptimizationTester:
    ...
    def _calculate_improvement(self, baseline: TestResult, current: TestResult) -> Dict[str, Any]:
        ...
        overall_improvement = (time_improvement * 0.4 + 
