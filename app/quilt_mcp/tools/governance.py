...
async def admin_sso_config_get() -> Dict[str, Any]:
    ...
    try:
        ...
        config_data = {
            ...
            'uploader': {
                'name': sso_config.uploader.name,
                'email': sso_config.uploader.email
            } if sso_config.uploader else None
        }
...
async def admin_sso_config_remove() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            'success': True,
            'message': 'Successfully removed SSO configuration'
        }
