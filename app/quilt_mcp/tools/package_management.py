...
def package_validate(
    ...
    try:
        ...
        if validation_results["inaccessible_files"] > 0:
            validation_results["warnings"].append(f"{validation_results['inaccessible_files']} files have access issues")
        ...
        return {
            ...
            "recommendations": [
                "Package appears healthy" if validation_results["inaccessible_files"] == 0 
