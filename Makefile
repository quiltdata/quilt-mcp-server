...
help:
	...
	@echo "  make deploy-docker    - Complete ECS deployment with all learnings (auto-version)"
	@echo "  make validate-deployment - Validate ECS deployment health and status"
	@echo ""
