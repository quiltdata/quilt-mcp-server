...
def filesystem_check() -> dict[str, Any]:
    ...
    if result.get("home_writable"):
        result.update(
            ...
            tools_available=[
                "auth_check", "filesystem_check", "packages_list", "packages_search",
                "package_browse", "package_contents_search", "package_create", "package_update",
        ...
        result.update(
            ...
            tools_available=[
                "auth_check", "filesystem_check", "packages_list", "package_browse", "package_contents_search"
            ],
        ...
        result.update(
            ...
            tools_available=["auth_check", "filesystem_check"]
        )
